(function ($) {
        $.fn.tblToExcel = function (link) {
            ...
            var tableToExcel = (function () {
                ...
                return function (table, name) {
                    ...
                    if (elm) {
                        ...
                        $(link).attr('download', todaysDate + 'posts-stats.xls');
            ...
            return this.each(function () {
                // gives name to the excel sheet
                var name = $.datepicker.formatDate('dd-mm-yy', new Date());
                // and execute
                tableToExcel(this, name);
            });
        }
